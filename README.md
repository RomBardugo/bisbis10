...
## Overview
The bisbis10 restaurant management system is a backend service designed to handle various operations related to restaurants, their dish, and ratings. The system aims to provide a comprehensive platform for managing restaurant data, including details about the restaurants, their cuisines, dish, and customer ratings.
...
- **Dishes API**: Manages the dish offered by each restaurant.
...
| Get restaurant            | GET /restaurants/{id}      |                                                          | 200 OK          | {"id": "1","name": "Taizu","rating" : 4.83,"isKosher" : false,"cuisines": ["Asian","Mexican","Indian"],"dish": [{"id": "1","name": "Noodles","description": "Amazing one","price": 59}]} |
...
| API Description           | Endpoint                | Request Body                             | Response Status | Response Body                                                     |
|---------------------------|-------------------------|------------------------------------------|-----------------|------------------------------------------------------------------|
| Add a dish                | POST /restaurants/{id}/dish | {"name":"Shakshuka","description":"Great one","price": 34} | 201 CREATED     |                                                                  |
| Update a dish             | PUT /restaurants/{id}/dish/{dishId} | {"description":"Great one","price": 34} | 200 OK          |                                                                  |
| Delete a dish             | DELETE /restaurants/{id}/dish/{dishId} |                                        | 204 No Content  |                                                                  |
| Get dish by a restaurant| GET /restaurants/{id}/dish  |                                         | 200 OK          | [{"id":"1","name":"Humus","description":"Good one","price": 48}] |
